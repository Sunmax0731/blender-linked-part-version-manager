...
- [ ] Blender runtime gate で統合 `.blend` と部位別 `.blend` の Link 更新を確認する。Alpha release 後の手動確認として実施する。 [phase=05-test]
...
- [ ] ユーザー手元の Blender で alpha manual test を実行し、結果を次リリースの evidence に反映する。 [phase=06-release]
