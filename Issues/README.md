...
This folder stores local Markdown issues linked from `TODO.md`.

## Status

- `open`: 未着手または作業中。
- `blocked`: 外部条件待ち。Issue に直接原因と次アクションを残す。
- `done`: code、docs、tests、QCDS evidence が同期済み。
...
- [x] [0020](0020-character-blend.md) Character.blend統合構成の関係表作成
