...
| `blender.link` | linked library 検出、Link 追加前の collection / object inspection、object type 分類、production target 推奨、非 3D model object の明示 Link、reload、linked datablock local 化、broken link レポート |
