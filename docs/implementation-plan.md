...
- [x] source `.blend` 内の nested Blender Link を `sourceLinkedLibraries` / `indirectLinkedLibraries` として report する。
...
- [x] source linked library inspection と indirect linked library reporting を Python unit test に追加する。
